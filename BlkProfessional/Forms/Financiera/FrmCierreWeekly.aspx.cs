...
{
    public partial class FrmCierreWeekly : System.Web.UI.Page
    {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    if (listaObjetos.data != null)
                    {
                        ...
                        if (dtbRegsiter.Rows.Count > 0)
                        {
                            ...
                            {
                                var worksheet = workbook.Worksheets.Add(dtbRegsiter.Rows[i]["Location"].ToString());

                                RequesItemLedgerEntry objetos = new RequesItemLedgerEntry
                                {
                                    Terminal = ddl_Terminal.SelectedValue,
                                    LocationCode = dtbRegsiter.Rows[i]["Location"].ToString(),
                                    CodigoCliente = txtCliente.Text,       
