...
{
    public partial class FrmCierreBarrancaAlm : System.Web.UI.Page
    {
        ...
        protected void gvCierre_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                decimal TotalValor = Convert.ToDecimal(e.Row.Cells[3].Text);
                e.Row.Cells[3].Text = String.Format("${0:#,##0}", TotalValor);
