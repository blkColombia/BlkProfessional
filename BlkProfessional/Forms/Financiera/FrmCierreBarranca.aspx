<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmCierreBarranca.aspx.cs" Inherits="BlkProfessional.Forms.Financiera.FrmCierreBarranca" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <h1 style="text-align: center;">Cierre Ecopetrol</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Cierre Ecopetrol</label>
            </div>
