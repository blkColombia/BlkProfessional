<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmCierreBarrancaDetalle.aspx.cs" Inherits="BlkProfessional.Forms.Financiera.FrmCierreBarrancaDetalle" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <h1 style="text-align: center;">Informe de Cierre Ecopetrol</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Informe de Cierre Ecopetrol</label>
            </div>
                                    ...
                                    <asp:BoundField DataField="Estado" HeaderText="Estado" SortExpression="Estado" />
                                     <asp:TemplateField HeaderText="Acciones">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton CommandName="Visualizar" CommandArgument='<%# Eval("Concepto") %>' runat="server" CssClass="btn btn-link btn-sm">Gestionar
