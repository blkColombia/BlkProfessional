<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmCierreCTG.aspx.cs" Inherits="BlkProfessional.Forms.Financiera.CTG.FrmCierreCTG" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <h1 style="text-align: center;">Cierre Cartagena</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Cierre Cartagena</label>
            </div>
