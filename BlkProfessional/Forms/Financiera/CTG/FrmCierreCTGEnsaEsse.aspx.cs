...
{
    public partial class FrmCierreCTGEnsaEsse : System.Web.UI.Page
    {
        ...
        public void generarPdf()
        {
            ...
            if (dtb.Rows.Count > 0)
            {
                try
                {
                    ...
                    string relativeFilePath = Path.Combine(relativeFolderPath, "Liquidacion_" + timestamp + ".pdf");
                    ...
                    PdfPCell SubEncPedido = new PdfPCell(new Phrase("No Pedido : " + "Prueba", _standardFont));
                    ...
                    PdfPCell SubEncPedidoCPA = new PdfPCell(new Phrase("No Pedido : " + "", _standardFont));
                    ...
                    PdfPCell clEntradas = new PdfPCell(new Phrase("Deposito Propio", _standardFontEncTabla));
                    ...
                    PdfPCell clSalidas = new PdfPCell(new Phrase("Entradas", _standardFontEncTabla));
                    ...
                    PdfPCell clInvTotal = new PdfPCell(new Phrase("Salidas", _standardFontEncTabla));
                    ...
                    PdfPCell clInvLibre = new PdfPCell(new Phrase("Saldos", _standardFontEncTabla));
                    ...
                    PdfPCell clInvFacturar = new PdfPCell(new Phrase("Valor Almto", _standardFontEncTabla));
                    ...
                    PdfPCell clValorAlmacenamiento = new PdfPCell(new Phrase("Valor C/D", _standardFontEncTabla));
                    ...
                    decimal valorCarguesDescargues = Convert.ToDecimal(txtTotalIngresosDesc.Text.Replace(",", ""));
                    clInvFacturar = new PdfPCell(new Phrase("$ " + valorCarguesDescargues.ToString("#,##0"), _standardFont));
                    clInvFacturar.BorderWidth = 0.5f;
                    clInvFacturar.PaddingTop = 7f;
                    clInvFacturar.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                    clInvFacturar.VerticalAlignment = PdfPCell.ALIGN_CENTER;
