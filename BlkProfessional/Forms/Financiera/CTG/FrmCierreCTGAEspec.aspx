<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmCierreCTGAEspec.aspx.cs" Inherits="BlkProfessional.Forms.Financiera.CTG.FrmCierreCTGAEspec" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <h1 style="text-align: center;">Informe de Cierre Cartagena</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Informe Cierre Cartagena</label>
            </div>
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="gvCierre" runat="server" AutoGenerateColumns="false" OnRowDataBound="gvCierre_RowDataBound" CssClass="table table-bordered table-striped" OnRowCommand="gvCierre_RowCommand">
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoLiquidacion" HeaderText="TipoLiquidacion" SortExpression="TipoLiquidacion" Visible="false" />
                                <asp:BoundField DataField="Llave" HeaderText="Concepto" SortExpression="Concepto" />
                                <asp:BoundField DataField="SaldoFinal" HeaderText="SaldoFinal" SortExpression="SaldoFinal" />
                                 <asp:BoundField DataField="ValorAlmacenamiento" HeaderText="Valor Almacenamiento" SortExpression="Valor Almacenamiento" />
                                 <asp:BoundField DataField="ValorDescarga" HeaderText="Valor Descarga" SortExpression="Valor Descarga" />

                                <asp:TemplateField HeaderText="Acciones">
                                    <ItemTemplate>
                                        <!-- Agrega aquí tus iconos y lógica -->
                                        <asp:LinkButton CommandName="Visualizar" CommandArgument='<%# Eval("IdAlmacenamiento") %>' runat="server" CssClass="btn btn-link btn-sm">Gestionar
