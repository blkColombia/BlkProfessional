<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmCierreCTGFraccion.aspx.cs" Inherits="BlkProfessional.Forms.Financiera.CTG.FrmCierreCTGFraccion" %>
                     ...
                     <div class="col-md-12">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <asp:DropDownList ID="ddl_Terminal" runat="server" Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="ddl_Terminal_SelectedIndexChanged" CssClass="form-control" ></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                     ...
                     <div class="col-md-12">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                          <asp:TextBox ID="txtImportacion" Enabled="false" placeholder="Importacion"  CssClass="form-control"  style="width: 100% !important;" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6" >
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                            <asp:GridView ID="GridViewLiquidacion" ShowFooter="true" runat="server" OnRowDataBound="GridViewLiquidacion_RowDataBound" AutoGenerateColumns="false" CssClass="table table-bordered table-striped" OnRowCommand="GridViewLiquidacion_RowCommand">
                                ...
                                <%--    <asp:BoundField DataField="NumeroToneladas" HeaderText="Numero Toneladas" SortExpression="Numero Toneladas" />
                                ...
                                <%--                           <asp:BoundField DataField="DiasAlmacenamiento" HeaderText="Dias Almacenamiento" SortExpression="Dias Almacenamiento" />
                                <%-- <asp:BoundField DataField="ValorAlmacenamiento" HeaderText="Almacenamiento" SortExpression="Almacenamiento" />--%>
                                <%--      <asp:BoundField DataField="ValorAlmacenamiento" HeaderText="Valor Almacenamiento" SortExpression="ValorAlmacenamiento"  />--%>
                                <%-- <asp:BoundField DataField="ValorDescarga" HeaderText="Descarga" SortExpression="ValorDescarga" />--%>
                                   

                                    <asp:TemplateField HeaderText="Numero Toneladas" >
			                         <ItemTemplate>
				                        <asp:Label ID="lblNumeroToneladas" runat="server" Text='<%# Eval("NumeroToneladas") %>'  />
			                         </ItemTemplate>
			                         <FooterTemplate >
                                      ...
                                      <asp:TemplateField HeaderText="Dias Almacenamiento" >
			                         <ItemTemplate>
				                        <asp:Label ID="lblSalidas" runat="server" Text='<%# Eval("DiasAlmacenamiento") %>'  />
			                         </ItemTemplate>
			                         <FooterTemplate >
				                        <asp:Label ID="lblTotalSalidas" runat="server" />
                                         ...
                                         <asp:TemplateField HeaderText="Valor Almacenamiento" >
			                         <ItemTemplate>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <asp:Button ID="btnEnvar" Enabled="false" Visible="false" CssClass="btn btn-warning" OnClick="btnEnvar_Click" runat="server" Text="Aprobar" />
                                </div>
                                <div class="col-sm-6">                                   
                                </div>
                            </div>
