<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmCierreCTGEnsaEsse.aspx.cs" Inherits="BlkProfessional.Forms.Financiera.CTG.FrmCierreCTGEnsaEsse" %>
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="GridViewLiquidacion" ShowFooter="true" runat="server" OnRowDataBound="GridViewLiquidacion_RowDataBound" AutoGenerateColumns="false" CssClass="table table-bordered table-striped" Visible="false" OnRowCommand="GridViewLiquidacion_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="DepositoPropio">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDepositoPropio" runat="server" Text='<%# Eval("DepositoPropio") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lblDepositoPropio" runat="server" />
                                    </FooterTemplate>
                                </asp:TemplateField>
