...
{
    public partial class FrmCierreCTGAlmCPA : System.Web.UI.Page
    {
        ...
        protected void btnEnvar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                GFCierreFinancieroDetalle_BRL.InsertarOrUpdate(objAct, 21);
        ...
        public void generarPdf()
        {
            ...
            if (dtb.Rows.Count > 0)
            {
                try
                {
                    ...
                    string relativeFilePath = Path.Combine(relativeFolderPath, "LiquidacionCPA_" + timestamp + ".pdf");
                    ...
                    PdfPCell SubEncPedido = new PdfPCell(new Phrase("No Pedido : " + txtNumeroPedido.Text, _standardFont));
                    ...
                    PdfPCell SubEnc1CPA = new PdfPCell(new Phrase("LIQUIDACION DE ALMACENAMIENTO", _standardFontEncabezado));
                    ...
                    PdfPCell SubEncPedidoCPA = new PdfPCell(new Phrase("No Pedido : " + txtNumeroPedido.Text, _standardFont));
                    SubEncPedidoCPA.BorderWidth = 0;
                    PdfPCell SubEncTarifaCPA = new PdfPCell(new Phrase("Tarifa : " + txtTarifaAlmacenamiento.Text, _standardFont));
                    ...
                    PdfPTable tblKardex = new PdfPTable(8);
                    ...
                    PdfPCell clInvTotal = new PdfPCell(new Phrase("Inv Total", _standardFontEncTabla));
                    ...
                    PdfPCell clInvLibre = new PdfPCell(new Phrase("Inv Libres", _standardFontEncTabla));
                    clInvLibre.BorderWidth = 0.5f;
                    clInvLibre.BackgroundColor = new BaseColor(250, 98, 21);
                    clInvLibre.PaddingBottom = 4f;
                    clInvLibre.PaddingTop = 7f;
                    clInvLibre.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                    clInvLibre.VerticalAlignment = PdfPCell.ALIGN_CENTER;

                    PdfPCell clInvFacturar = new PdfPCell(new Phrase("Inv Facturar", _standardFontEncTabla));
                    clInvFacturar.BorderWidth = 0.5f;
                    clInvFacturar.BackgroundColor = new BaseColor(250, 98, 21);
                    clInvFacturar.PaddingBottom = 4f;
                    clInvFacturar.PaddingTop = 7f;
                    clInvFacturar.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                    clInvFacturar.VerticalAlignment = PdfPCell.ALIGN_CENTER;

                    PdfPCell clValorAlmacenamiento = new PdfPCell(new Phrase("Valor Dia", _standardFontEncTabla));
                    ...
                    tblKardex.AddCell(clInvLibre);
                    tblKardex.AddCell(clInvFacturar);
                    ...
                    for (int i = 0; i < GridViewLiquidacion.Rows.Count; i++)
                    {
                        ...
                        clInvLibre = new PdfPCell(new Phrase(((Label)row.Cells[8].Controls[1]).Text, _standardFont));
                        clInvLibre.BorderWidth = 0.5f;
                        clInvLibre.PaddingTop = 7f;
                        clInvLibre.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                        clInvLibre.VerticalAlignment = PdfPCell.ALIGN_CENTER;

                        clInvFacturar = new PdfPCell(new Phrase(((Label)row.Cells[9].Controls[1]).Text, _standardFont));
                        clInvFacturar.BorderWidth = 0.5f;
                        clInvFacturar.PaddingTop = 7f;
                        clInvFacturar.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                        clInvFacturar.VerticalAlignment = PdfPCell.ALIGN_CENTER;

                        clValorAlmacenamiento = new PdfPCell(new Phrase(((Label)row.Cells[10].Controls[1]).Text, _standardFont));
                        clValorAlmacenamiento.BorderWidth = 0.5f;
                        clValorAlmacenamiento.PaddingTop = 7f;
                        clValorAlmacenamiento.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                        clValorAlmacenamiento.VerticalAlignment = PdfPCell.ALIGN_CENTER;
        ...
        private void ExportToExcel(DataTable table, string filePath)
        {
            ...
            sw.Write("<td></td>");
            sw.Write("</tr>");
            sw.Write("<tr><td colspan='5'></td><td colspan='2' style='border: 1px solid #000000;'><b>LIQUIDACION DE ALMACENAMIENTO</b></td><td></td></tr>");
        ...
        protected void GridViewLiquidacion_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label lblSaldoLibre = (Label)e.Row.FindControl("lblSaldoLibre");
                if (!String.IsNullOrEmpty(lblSaldoLibre.Text) && lblSaldoLibre.Text != "&nbsp;")
                {
                    string precios = (String.IsNullOrEmpty(lblSaldoLibre.Text)) ? "0" : lblSaldoLibre.Text;
                    decimal precio = Convert.ToDecimal(precios);
                    totalSaldo += precio;
                    lblSaldoLibre.Text = String.Format("{0:N0}", Math.Abs(Convert.ToDecimal(lblSaldoLibre.Text)));
                    txtSaldoLibreTotal.Text = precio.ToString();
                }

                Label lblSaldoFacturar = (Label)e.Row.FindControl("lblSaldoFacturar");
                if (!String.IsNullOrEmpty(lblSaldoFacturar.Text) && lblSaldoFacturar.Text != "&nbsp;")
                {
                    string precios = (String.IsNullOrEmpty(lblSaldoFacturar.Text)) ? "0" : lblSaldoFacturar.Text;
                    decimal precio = Convert.ToDecimal(precios);
                    totalSaldo += precio;
                    lblSaldoFacturar.Text = String.Format("{0:N0}", Math.Abs(Convert.ToDecimal(lblSaldoFacturar.Text)));
                    txtSaldoFacturarTotal.Text = precio.ToString();
                }
