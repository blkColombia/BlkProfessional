<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmCierreCTGImportacion.aspx.cs" Inherits="BlkProfessional.Forms.Financiera.CTG.FrmCierreCTGImportacion" %>
                    ...
                    <div class="col-md-12">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                 <asp:TextBox ID="txtFechaInicio" Enabled="false"   placeholder="Fecha Inicio"  CssClass="form-control"  style="width: 100% !important;" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                     <asp:TextBox ID="txtFechaFin" Enabled="false"  placeholder="Fecha Fin"  CssClass="form-control"  style="width: 100% !important;" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
