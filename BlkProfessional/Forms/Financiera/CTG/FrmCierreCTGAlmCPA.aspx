<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmCierreCTGAlmCPA.aspx.cs" Inherits="BlkProfessional.Forms.Financiera.CTG.FrmCierreCTGAlmCPA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <br />
        <h1 style="text-align: center;">Cierre de Almacenamiento y Descarga</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Cierre de Almacenamiento y Descarga</label>
            </div>
            <div class="panel-body">
                <div class="row" style="padding: 10px;">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <asp:TextBox ID="txtTelefono" Visible="false" CssClass="form-control" Style="width: 100% !important;" runat="server"></asp:TextBox>
                                    <asp:TextBox ID="txtDireccion" Visible="false" CssClass="form-control" Style="width: 100% !important;" runat="server"></asp:TextBox>
                                    <asp:TextBox ID="txtCiudad" Visible="false" CssClass="form-control" Style="width: 100% !important;" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList ID="ddl_Terminal" runat="server" AutoPostBack="true" Enabled="false" OnSelectedIndexChanged="ddl_Terminal_SelectedIndexChanged" CssClass="form-control"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList ID="ddlLocation" runat="server" CssClass="form-control" Enabled="false"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList ID="ddlCliente" Enabled="false" OnSelectedIndexChanged="ddlCliente_SelectedIndexChanged" runat="server" AutoPostBack="true" CssClass="form-control"></asp:DropDownList>
                                    ...
                                    <asp:TextBox ID="txtSaldoTotal" Visible="false" CssClass="form-control" Style="width: 100% !important;" runat="server"></asp:TextBox>
                                    <asp:TextBox ID="txtSaldoLibreTotal" Visible="false" CssClass="form-control" Style="width: 100% !important;" runat="server"></asp:TextBox>
                                    <asp:TextBox ID="txtSaldoFacturarTotal" Visible="false" CssClass="form-control" Style="width: 100% !important;" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="txtRepPassword" class="col-sm-4 col-form-label">Tarifa Descarga</label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtTarifaDescarga" placeholder="Tarifa Descarga" Enabled="false" CssClass="form-control" Style="width: 100% !important;" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="txtRepPassword" class="col-sm-4 col-form-label">Numero Pedido</label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtNumeroPedido" placeholder="No Pedido" CssClass="form-control" Style="width: 100% !important;" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-sm-6">
                            <div class="col-md-12">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label for="txtRepPassword" class="col-sm-4 col-form-label">Generar Liquidacion</label>
                                        <div class="col-sm-8">
                                            <%--                                 <asp:TextBox ID="TextBox2" placeholder="Tarifa Descarga" Enabled="false" CssClass="form-control"  style="width: 100% !important;" runat="server"></asp:TextBox>--%>
                                            <asp:RadioButtonList ID="rdbGenerarLiq" runat="server">
                                ...
                                <div class="col-sm-6">
                                     <div class="form-group row">
                                        <label for="txtRepPassword" class="col-sm-4 col-form-label">Documento</label>
                                        <div class="col-sm-8">
                                            <%--                                 <asp:TextBox ID="TextBox2" placeholder="Tarifa Descarga" Enabled="false" CssClass="form-control"  style="width: 100% !important;" runat="server"></asp:TextBox>--%>
                                            <asp:RadioButtonList ID="rdbTipoDocumento" runat="server">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <asp:Button ID="btnDescargar" CssClass="btn btn-warning" OnClick="btnDescargar_Click" runat="server" Text="Generar" />
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="GridViewLiquidacion" ShowFooter="true" runat="server" OnRowDataBound="GridViewLiquidacion_RowDataBound" AutoGenerateColumns="false" CssClass="table table-bordered table-striped" Visible="false" OnRowCommand="GridViewLiquidacion_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Inv Total">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSaldo" runat="server" Text='<%# Eval("Saldo") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lblTotalSaldo" Visible="false" runat="server" />
                                    </FooterTemplate>
                                </asp:TemplateField>


                                <asp:TemplateField HeaderText="Inv Dias Libres">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSaldoLibre" runat="server" Text='<%# Eval("SaldoLibre") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lblTotalSaldoLibre" runat="server" />
                                    </FooterTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Inv Facturar">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSaldoFacturar" runat="server" Text='<%# Eval("SaldoFacturar") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lblTotalSaldoFacturar" runat="server" />
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Cargue/Descarga" Visible="false">
                                    <ItemTemplate>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <asp:Button ID="btnVolver" Visible="true" CssClass="btn btn-warning" OnClick="btnVolver_Click" runat="server" Text="Volver" />
                                    <asp:Button ID="btnEnvar" Visible="false" Enabled="false" CssClass="btn btn-warning" OnClick="btnEnvar_Click" runat="server" Text="Enviar" />
                                </div>
                                <div class="col-sm-6">
                                </div>
                            </div>
