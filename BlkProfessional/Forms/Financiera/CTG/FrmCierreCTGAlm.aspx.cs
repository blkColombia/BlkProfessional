...
{
    public partial class FrmCierreCTGAlm : System.Web.UI.Page
    {
        ...
        protected void gvCierre_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Visualizar")
            {
                ...
                string usuario = Request.QueryString["usuario"];
                Response.Redirect($"FrmCierreCTGAEspec.aspx?usuario={usuario}&IdCierreDetalle={idCierreDetalle}&IdCierre={idCierre}&Terminal=CTG");
        ...
        protected void btnVolver_Click(object sender, EventArgs e)
        {
            ...
            string usuario = Request.QueryString["usuario"];
            string idCierre = Request.QueryString["IdCierre"];
            Response.Redirect($"FrmCierreCTGDetalle.aspx?usuario={usuario}&IdCierre={idCierre}");
        }
    }
}