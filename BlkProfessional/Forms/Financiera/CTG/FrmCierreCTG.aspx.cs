...
{
    public partial class FrmCierreCTG : System.Web.UI.Page
    {
        ...
        protected void gvCierre_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Visualizar")
            {
                ...
                string usuario = Request.QueryString["usuario"];
                Response.Redirect($"FrmCierreCTGDetalle.aspx?usuario={usuario}&IdCierre={idCierre}&Terminal=CTG");
        ...
        protected void gvCierre_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //{
            //    decimal TotalIngresos = Convert.ToDecimal(e.Row.Cells[3].Text);
            ...
            //    e.Row.Cells[3].Text = String.Format("${0:#,##0}", TotalIngresos);
