...
{
    public partial class FrmCierreCTGImportacion : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            DCL.GFCierreFinanciero objCierre = new DCL.GFCierreFinanciero();
            objCierre.IdCierre = Convert.ToInt32(idCierre);
            DataTable dtbCierre = GFCierreFinanciero_BRL.SelectTable(objCierre, 1);
            if (dtbCierre.Rows.Count > 0) {

                txtFechaInicio.Text = dtbCierre.Rows[0]["FechaInicial"].ToString();
                txtFechaFin.Text = dtbCierre.Rows[0]["FechaFinal"].ToString();
            }
