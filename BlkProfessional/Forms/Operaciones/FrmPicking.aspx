<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmPicking.aspx.cs" Inherits="BlkProfessional.Forms.Operaciones.FrmPicking" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">     
        ...
        <br />
        <h1 style="text-align: center;">Informe Picking</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Informes Picking</label>
            </div>
