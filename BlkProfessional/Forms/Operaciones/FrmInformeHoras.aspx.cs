...
{
    public partial class FrmInformeHoras : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (listaObjetos.data != null)
                {
                    ...
                    if (dtb.Rows.Count > 0)
                    {
                        ...
                        string rutarchivo = Server.MapPath("~/InformeTiemposEjecutados.xls");
                        ...
                        response.AddHeader("Content-Disposition", "attachment; filename=" + "InformeTiemposEjecutados" + ".xls" + ";");
