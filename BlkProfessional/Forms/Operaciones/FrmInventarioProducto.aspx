<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmInventarioProducto.aspx.cs" Inherits="BlkProfessional.Forms.Operaciones.FrmInventarioProducto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <br />
        <h1 style="text-align: center;">Informe de Liquidacion de Inventarios por Producto</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Informes de Liquidacion de Inventarios por Producto</label>
            </div>
