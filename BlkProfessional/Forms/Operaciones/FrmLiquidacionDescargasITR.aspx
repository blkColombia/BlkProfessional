<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmLiquidacionDescargasITR.aspx.cs" Inherits="BlkProfessional.Forms.Operaciones.FrmLiquidacionDescargasITR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <br />
        <h1 style="text-align: center;">Informe de Descargas de ITR</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Informes de Descargas Liquidacion ITR</label>
            </div>
