<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmInformeTolvas.aspx.cs" Inherits="BlkProfessional.Forms.Operaciones.FrmInformeTolvas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <h1 style="text-align: center;">Informe de Tolvas</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Informes de Tolvas</label>
            </div>
                     ...
                     <div class="col-md-12">
                            <asp:GridView ID="gvTolvas" runat="server" AutoGenerateColumns="false" OnRowDataBound="gvTolvas_RowDataBound" CssClass="table table-bordered table-striped" OnRowCommand="gvTolvas_RowCommand">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Cliente" HeaderText="Proyecto" SortExpression="Proyecto" />
                                    <asp:BoundField DataField="TotalIngresos" HeaderText="Total Ingresos" SortExpression="Total Ingresos" />
                                     <asp:BoundField DataField="TotalCostoFijo" HeaderText="Total Costo Fijo" SortExpression="Total Costo Fijo" />
                                    <asp:BoundField DataField="TotalCostosVariables" HeaderText="Total Costos Variables" SortExpression="Total Costos Variables al Cliente" />
                                    <asp:BoundField DataField="Utilidad" HeaderText="Utilidad" SortExpression="Utilidad" />
