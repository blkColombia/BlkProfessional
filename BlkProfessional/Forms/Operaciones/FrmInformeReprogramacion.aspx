<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmInformeReprogramacion.aspx.cs" Inherits="BlkProfessional.Forms.Operaciones.FrmInformeReprogramacion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">     
        ...
        <br />
        <h1 style="text-align: center;">Informe Reprogramacion</h1>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <label class="col-form-label">Informes Reprogramacion</label>
            </div>
