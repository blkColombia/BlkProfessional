<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmTareaLider.aspx.cs" Inherits="BlkProfessional.Forms.TalentoHumano.FrmTareaLider" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="formularios">
        ...
        <div class="row">
            <div class="col">
                <h1 style="text-align: center;">Seguimiento Cierre de Brechas</h1>
                <br>
            </div>
        </div>
        <div class="row">
